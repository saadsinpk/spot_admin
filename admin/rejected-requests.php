					...
					<div class="col-12">
                        <div class="block bg-white table-block mb-4">
                            <div class="block-heading">
                                ...
                                <p class="mt-2">Showing All Rejected Requests from the Users.</p>
                            </div>
	...
	?>
		<tr>
            ...
            <td>
                ...
                <a href="process/complete.php?type=process&id=<?php echo $request['rid']; ?>" class="btn btn-warning btn-small"><i class="dripicons-clock"></i>Processing</a>
            </td>
        </tr>
	<?php
    }
