									...
									<div class="task align-items-center" style="cursor: auto;">
										<div class="members single">
											<div class="member rounded-circle float-left" style=" border-radius: 0%; width: 60px; height: 60px;">
												<img class="img-fluid" src="images/<?php echo $payout['payout_thumbnail']; ?>" />
											</div>
										</div>
										<div class="task-desc">
										...
										<div class="members single">
											...
											<a href="edit-payout.php?id=<?php echo $payout['payout_id']; ?>" class="btn btn-warning btn-small"><i class="fa fa-edit"></i>Edit</i></a>
											</div>
										</div>
									</div>
								</li>
