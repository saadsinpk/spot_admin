<?php
    ...
    if (!admin::isSession()) {
        ...
        $wall_data = $offerwalls->getSingleOfferWall($ID);
        
        if(!isset($wall_data['offer_id'])){
        ...
        $inc_file = "inc/offerwalls/".$wall_data['offer_type'].".php";
                    ...
                    <div class="col-md-12">
                        <div class="block form-block mb-4">
                            <div class="block-heading">
                                <h5><?= $wall_data['offer_title'] ?> Configuration</h5>
                            </div>

                            <form action="process/edit-offerwall.php" method="post" enctype="multipart/form-data" class="horizontal-form" />
							
                                <div class="form-group">
                                    <div class="form-row">
                                        <label class="col-md-3">Position</label>
                                        <div class="col-md-9">
                                            <input class="form-control" name="position" type="number" value="<?= $wall_data['offer_position'] ?>" required=""/>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-9">
                                            <input class="form-control" name="id" type="text" value="<?= $wall_data['offer_id'] ?>" hidden/>
                                            <input class="form-control" name="type" type="text" value="<?= $wall_data['offer_type'] ?>" hidden/>
                                            <input class="form-control" name="name" type="text" value="<?= $wall_data['offer_title'] ?>" required=""/>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-9">
                                            <input class="form-control" name="sub" type="text" value="<?= $wall_data['offer_subtitle'] ?>" required=""/>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-9">
                                            <div class="input-group">
                                                <input id="image_name" class="form-control" type="text" name="image_name" value="<?= basename($wall_data['offer_thumbnail']) ?>" placeholder="Choose Image" style="background: #e9ecef; " autocomplete="off" disabled/>
